# Instalação para homologação local

Use este instalador somente em laboratório ou estação de teste fora do Active Directory.
...
O artefato de homologação local ignora apenas o gate de ingresso no AD/gerenciamento corporativo. Permanecem obrigatórios:
...
> Não use este instalador como alternativa ao pacote Corporativo em produção.
